{
	...
	warrior.addEventListener('click', () => {
		...
		wrapper.style.backgroundImage = 'url(\'images/backgrounds/warrior.jpg\')';
	});
	...
	rogue.addEventListener('click', () => {
		...
		wrapper.style.backgroundImage = 'url(\'images/backgrounds/rogue.jpg\')';
	});
	...
	mage.addEventListener('click', () => {
		...
		wrapper.style.backgroundImage = 'url(\'images/backgrounds/mage.jpg\')';
	});
