...
const perfecedStrike = new CreateCardSkills(4, 'attackAddEffect', 1, 6, 'css/images/cards/warrior/PerfectedStrike.png', 'perfecedStrike', () => 6 + boardModel.cardInHand.children.length);
...
const flechettes = new CreateCardSkills(2, 'attackAddEffect', 1, 3, 'css/images/cards/rogue/Flechettes.png', 'flechettes', () => 3 * boardModel.cardInHand.children.length);
