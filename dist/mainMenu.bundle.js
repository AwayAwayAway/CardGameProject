...
var MainMenu = /*#__PURE__*/function (_Menu) {
  ...
  function MainMenu() {
    ...
    _this.aboutGame = document.querySelector('.aboutButton');
  ...
  _createClass(MainMenu, [{
    ...
    value: function checkContinueCondition() {
      ...
      if (!temp) {
        document.querySelector('.continueButton').addEventListener('click', function (event) {
    ...
    value: function createAboutRules() {
      ...
      document.querySelector('.closeRuleBtn').addEventListener('click', function () {
        return _this2.removeAboutRules();
      });
      document.querySelector('.closeRuleBtn').addEventListener('mouseover', function () {
        return (0,_animation_and_sound_effects_animation_js__WEBPACK_IMPORTED_MODULE_0__.playSoundEffect)('.btn-hover-audio');
      });
      document.querySelector('.closeRuleBtn').addEventListener('click', function () {
        return (0,_animation_and_sound_effects_animation_js__WEBPACK_IMPORTED_MODULE_0__.playSoundEffect)('.btn-click-audio');
...
var ChooseMenu = /*#__PURE__*/function (_Menu2) {
  ...
  function ChooseMenu() {
    ...
    var _this4$source$ = _this4.source[4],
        enterName = _this4$source$.firstElementChild,
        applyChoose = _this4$source$.lastElementChild; // save name and model of character of each player
    ...
    _this4.prepareToExtract = function () {
      return {
