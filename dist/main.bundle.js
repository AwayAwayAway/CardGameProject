...
var reachHeaven = new _modules_cardsModel__WEBPACK_IMPORTED_MODULE_0__.default(2, 'attack', 2, 12, 'images/cards/mage/ReachHeaven.png', 'reachHeaven');
...
gameObserver.start();
boardView.init();
winConditionObserver.observe(_modules_observerModel__WEBPACK_IMPORTED_MODULE_8__.player1HPstatus, {
  childList: true,
  subtree: true,
  characterData: true
});
winConditionObserver.observe(_modules_observerModel__WEBPACK_IMPORTED_MODULE_8__.player2HPstatus, {
  childList: true,
  subtree: true,
  characterData: true
});
saveConcedeConditionObserver.observe(_modules_observerModel__WEBPACK_IMPORTED_MODULE_8__.battleground, {
  attributes: true
});
...
var Board = /*#__PURE__*/function () {
  function Board(model) {
    ...
    this.menuIcon = document.querySelector('.battle-field-nav__icon'); // создаем событие на создание карт
...
var BoardView = /*#__PURE__*/function () {
  function BoardView(board, game, selector) {
    ...
    this.forbidClick = function (event) {
    ...
    this.boardModel.menuIcon.addEventListener('click', function () {
      return _this.showMenu();
    });
    this.boardModel.menuIcon.addEventListener('click', function () {
      return (0,_animation_and_sound_effects_animation__WEBPACK_IMPORTED_MODULE_1__.playSoundEffect)('.btn-click-audio');
    });
    this.boardModel.menu.addEventListener('click', function (event) {
      return _this.navigateGame(event.target);
    });

    _toConsumableArray(this.boardModel.menu.getElementsByTagName('li')).forEach(function (button) {
      button.addEventListener('mouseover', function () {
        return (0,_animation_and_sound_effects_animation__WEBPACK_IMPORTED_MODULE_1__.playSoundEffect)('.btn-hover-audio');
      });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "player1HPstatus": function() { return /* binding */ player1HPstatus; },
/* harmony export */   "player2HPstatus": function() { return /* binding */ player2HPstatus; },
/* harmony export */   "endGame": function() { return /* binding */ endGame; },
/* harmony export */   "battleground": function() { return /* binding */ battleground; },
...
var player1HPstatus = document.querySelector('.player-1__hp');
var player2HPstatus = document.querySelector('.player-2__hp');
var battleground = document.querySelector('.battle-field');
...
function endGame(mutations) {
  if (mutations[0]['target'].classList.contains('player-1__hp-value') && mutations[0].target.childNodes[0].data <= 0) {
    document.querySelector('.players-action').textContent = "".concat(_game__WEBPACK_IMPORTED_MODULE_0__.gameObserver.playersInfo.playerTwoName, " is a winner");
    _game__WEBPACK_IMPORTED_MODULE_0__.boardModel.cardInHand.classList.add('hidden');
  ...
  if (mutations[0]['target'].classList.contains('player-2__hp-value') && mutations[0].target.childNodes[0].data <= 0) {
    document.querySelector('.players-action').textContent = "".concat(_game__WEBPACK_IMPORTED_MODULE_0__.gameObserver.playersInfo.playerOneName, " is a winner");
    _game__WEBPACK_IMPORTED_MODULE_0__.boardModel.cardInHand.classList.add('hidden');
    (0,_animation_and_sound_effects_animation__WEBPACK_IMPORTED_MODULE_1__.playSoundEffect)('.victory-audio');
    localStorage.removeItem('gameData');
  }
...
function allowSaveConcede() {
  document.querySelector('.save-progress').removeEventListener('click', _game__WEBPACK_IMPORTED_MODULE_0__.boardView.forbidClick);
  document.querySelector('.concede').removeEventListener('click', _game__WEBPACK_IMPORTED_MODULE_0__.boardView.forbidClick);
...
/* harmony import */ var _eventsModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./eventsModel */ "./js/modules/eventsModel.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var PlayersView = /*#__PURE__*/function () {
  function PlayersView(playerOneModel, playerTwoModel, gameModel, container) {
    ...
    this.updateInitialValue = new _eventsModel__WEBPACK_IMPORTED_MODULE_1__.default();
  ...
  _createClass(PlayersView, [{
    ...
    value: function updateDamageNumbers(passivePlayerUI) {
      ...
      (0,_animation_and_sound_effects_animation__WEBPACK_IMPORTED_MODULE_0__.damageNumbersAnimation)(passivePlayerUI, 'damageNumberAnimate', resultContent);
    }
  }, {
    key: "doAnimation",
    value: function doAnimation() {
      ...
      switch (this.gameModel.tempCard.name) {
        ...
        case 'cutThroughFate':
          ...
          setTimeout(function () {
            (0,_animation_and_sound_effects_animation__WEBPACK_IMPORTED_MODULE_0__.attackAnimationEffect)(activePlayerUI, direction);
            (0,_animation_and_sound_effects_animation__WEBPACK_IMPORTED_MODULE_0__.standartAttackAnimation)(passivePlayerUI, 'angerAttack', 'images/attack-effects/mageEffect.png');
            (0,_animation_and_sound_effects_animation__WEBPACK_IMPORTED_MODULE_0__.shakeAnimation)(passivePlayerUI);
            (0,_animation_and_sound_effects_animation__WEBPACK_IMPORTED_MODULE_0__.playSoundEffect)('.mage-attack-audio');
